						...
						<input type="hidden" name="tech_num" value="${board.tech_num}" />
								<table>
									<tbody>
										<tr>
											<td>
												<label for="tech_num">번호</label><input type="text" id="tech_num" name="tech_num" value="${board.tech_num}" readonly="readonly"/>
											</td>
										</tr>
										<tr>
											<td>
												<label for="user_id">이름</label><input type="text" id="user_id" name="user_id" value="${board.user_id}" readonly="readonly"/>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
												<label for="tech_title">제목</label><input type="text" id="tech_title" name="tech_title" value="${board.tech_title}"/>
											</td>
										</tr>	
										<tr>
											<td>
												<label for="tech_con">내용</label><textarea id="tech_con" name="tech_con"><c:out value="${board.tech_con}" /></textarea>
											</td>
										</tr>	
									</tbody>			
								</table>
